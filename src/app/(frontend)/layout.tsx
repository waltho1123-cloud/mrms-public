...
export default function FrontendLayout({
  ...
  const navLinks = [
    ...
    { href: '/admin', label: '後台管理', icon: CogIcon },
  ];

  // Render a minimal shell during SSR to avoid hydration mismatch
  // caused by browser extensions injecting attributes (e.g. rtrvr-*)
  if (!mounted) {
    return (
